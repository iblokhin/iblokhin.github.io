				...
				var radioOutput = function() {
					...
					radio.click(function(e) {
						...
						if (!radio.is('.disabled')) {
							...
							// меняем цвет label при изминении radio
							inputName.commonParent().find(inputName).prop('checked', false).parent().parent().removeClass('selected');

							el.prop('checked', true).parent().addClass('checked');
							// меняем цвет label при изминении radio
							el.prop('checked', true).parent().parent().addClass('selected');
							el.focus().change();
						}
					});
					// клик на label
					...
					function doSelect() {
						...
						divSelect.click(function() {
							...
							var dropUp = function() {
								...
								dropdown.height('auto').css({top: 'auto'});
